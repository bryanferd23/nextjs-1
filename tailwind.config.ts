...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Sophisticated monochromatic palette with blue accent
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      fontFamily: {
        ...
        mono: ['var(--font-geist-mono)', 'SF Mono', 'Monaco', 'Inconsolata', 'Roboto Mono', 'source-code-pro', 'Menlo', 'Consolas', 'monospace'],
      ...
      fontSize: {
        ...
        'sm': ['0.875rem', { lineHeight: '1.35', letterSpacing: '0.015em' }],
