...
export default function ThemeToggle() {
  ...
  if (!mounted) {
    // Return a placeholder that matches the size to prevent layout shift
    return (
      <div className="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-700 opacity-50">
